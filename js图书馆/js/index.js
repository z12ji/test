...
function initUserDatas() {
  var initUser1 = New(User, ["1001", "三国演义", "罗贯中", "北方", "134", "56"]);
  var initUser2 = New(User, ["1002", "水浒传", "施耐庵", "北方", "155", "56"]);
  var initUser3 = New(User, ["1003", "红楼梦", "曹雪芹", "北方", "231", "56"]);
  var initUser4 = New(User, ["1004", "西游记", "吴承恩", "北方", "243", "56"]);
